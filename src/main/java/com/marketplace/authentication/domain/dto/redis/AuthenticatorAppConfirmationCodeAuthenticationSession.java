...
public class AuthenticatorAppConfirmationCodeAuthenticationSession extends AuthenticationSession {

    public AuthenticatorAppConfirmationCodeAuthenticationSession(AuthenticationSession session) {
        if (session != null) {
